...
save_path = "data/SLR103/Hindi_train/train/attack-a1"
...
audios_tts_bark_list_female = list(pathlib.Path("data/SLR103/Hindi_train/train/tts-bark/").glob("female/*.wav"))
audios_tts_bark_list_male = list(pathlib.Path("data/SLR103/Hindi_train/train/tts-bark/").glob("male/*.wav"))
audios_tts_fbmms_list_female = list(pathlib.Path("data/SLR103/Hindi_train/train/tts-fbmms/").glob("*.wav"))
audios_tts_fbmms_list_male = list(pathlib.Path("data/SLR103/Hindi_train/train/tts-fbmms/").glob("*.wav"))
audios_tts_f2hs_list_female = list(pathlib.Path("data/SLR103/Hindi_train/train/tts-fs2hs/").glob("female/*.wav"))
audios_tts_f2hs_list_male = list(pathlib.Path("data/SLR103/Hindi_train/train/tts-fs2hs/").glob("male/*.wav"))
audios_tts_f2mfa_list_female = list(pathlib.Path("data/SLR103/Hindi_train/train/tts-fs2mfa/").glob("female/*.wav"))
audios_tts_f2mfa_list_male = list(pathlib.Path("data/SLR103/Hindi_train/train/tts-fs2mfa/").glob("male/*.wav"))
audios_tts_indic_list_female = list(pathlib.Path("data/SLR103/Hindi_train/train/tts-indic/").glob("female/*.wav"))
audios_tts_indic_list_male = list(pathlib.Path("data/SLR103/Hindi_train/train/tts-indic/").glob("male/*.wav"))
...
json.dump({"spoofed_segement":metadata_dict}, open("data/SLR103/Hindi_train/train/attack-a1-metadata.json", "w"))